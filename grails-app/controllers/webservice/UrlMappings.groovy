...
class UrlMappings {
    ...
    static mappings = {
       "/"(controller: 'application', action:'index')
        ...
        // ressources liées
        get "/api/bibliotheque/$id(.$format)?/livres/"(controller: "api", action:"bibliothequelivre")
        get "/api/bibliotheque/$id(.$format)?/livre/"(controller: "api", action:"bibliothequelivre")
    }
}
